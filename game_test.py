...
def test_player_creation():
    ...
    """
    my_game=game.Game(cards_in_hand=CARDS_IN_HAND, number_of_players=NUMBER_OF_PLAYERS, number_of_piles=NUMBER_OF_PILES, cards_per_turn=CARDS_PER_TURN, number_of_cards=NUMBER_OF_CARDS)
    my_player=my_game.players[0]
    assert my_player.is_my_turn==False
...
def test_pile_creation():
    ...
    assert len(my_drawing_pile.cards)==NUMBER_OF_CARDS-2-CARDS_IN_HAND*NUMBER_OF_PLAYERS
